    ...
    <div className="max-w-3xl mx-auto">
      <AnimatePresence mode="wait">
        {!isRunning && !isComplete && (
          ...
          >
            <div className="p-6 rounded-2xl bg-gradient-to-br from-primary-50 to-primary-100/50 dark:from-primary-950/50 dark:to-primary-900/30 border border-primary-100 dark:border-primary-900/40 mb-6">
              <Activity className="w-16 h-16 text-primary-500" />
            </div>
            <h2 className="text-2xl font-bold text-primary-900 dark:text-slate-100 mb-2">Diagnóstico Automático</h2>
            <p className="text-neutral-500 dark:text-slate-400 text-center max-w-md mb-8 leading-relaxed">
              Analiza en profundidad el hardware del equipo: CPU, memoria RAM, unidades de almacenamiento, batería, sensores térmicos y conectividad de red.
            </p>
        ...
        {isRunning && (
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="text-lg font-bold text-primary-900 dark:text-slate-100">Ejecutando Diagnóstico...</h2>
                <p className="text-xs text-neutral-500 dark:text-slate-400">Analizando componentes del equipo</p>
              </div>
            </div>
            {phases.map((phase, i) => (
        ...
        {isComplete && currentDiagnostic && (
          ...
          >
            <div className="bg-white dark:bg-slate-900 rounded-2xl border border-neutral-200/60 dark:border-slate-800 p-8 text-center shadow-sm">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="font-bold text-primary-900 dark:text-slate-200 text-sm uppercase tracking-wider">Resultados por Fase</h3>
              </div>
              {phases.map((phase, i) => (
                <ProgressCard key={phase.id} phase={phase} index={i} />
              ))}
            ...
            <div className="flex flex-wrap gap-4 justify-center pt-4">
              <Button variant="secondary" icon={<Play className="w-4 h-4" />} onClick={runDiagnostic}>
                Repetir Diagnóstico
              </Button>
